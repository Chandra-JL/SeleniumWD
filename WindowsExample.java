...
public class WindowsExample {
	...
	public static void main(String[] args) {
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", tabBtn ); // javascript executor is to scroll the page if there is any advertisment on webpage
				tabBtn.click();
